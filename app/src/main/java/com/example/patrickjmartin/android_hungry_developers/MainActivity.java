...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Developer dev1 = new Developer(1, spoon2, spoon1);
        new Thread(dev1).start();
        Developer dev2 = new Developer(2, spoon3, spoon2);
        new Thread(dev2).start();
        Developer dev3 = new Developer(3, spoon4, spoon3);
        new Thread(dev3).start();
        Developer dev4 = new Developer(4, spoon5, spoon4);
        new Thread(dev4).start();
        Developer dev5 = new Developer(5, spoon1, spoon5);
